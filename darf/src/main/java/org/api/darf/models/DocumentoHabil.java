...
@Entity // Indica que esta classe é uma entidade JPA mapeada para o banco de dados
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class DocumentoHabil {
    ...
    @Column(nullable = false)
    private StatusDocumento status; // Status atual do documento (ex: PAGO, EMITIDO, etc.)

    @Enumerated(EnumType.STRING)
    @Column(nullable = false)
    private NaturezaRendimento naturezaRendimento; // Tipo de rendimento relacionado ao serviço/produto
